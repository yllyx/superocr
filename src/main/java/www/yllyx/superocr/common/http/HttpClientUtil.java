 ...
 * @see javax.net.ssl.SSLException: hostname in certificate didn't match: <123.125.97.66> !=
 *      <123.125.97.241>
 * @see javax.net.ssl.SSLHandshakeException: sun.security.validator.ValidatorException: PKIX path
...
public class HttpClientUtil
{
    ...
    public static String sendPostRequest(String reqURL, String reqData, String encodeCharset)
    {
        ...
        // 由于下面使用的是new StringEntity(....),所以默认发出去的请求报文头中CONTENT_TYPE值为text/plain;
        // charset=ISO-8859-1
     ...
     * @return 远程主机响应正文
     */
    public static String sendGetSSLRequest(String reqURL, Map<String, String> params,
        String encodeCharset)
    {
        ...
        // 创建HostnameVerifier
        // 用于解决javax.net.ssl.SSLException: hostname in certificate didn't match: <123.125.97.66> !=
        // <123.125.97.241>
        ...
        try
        {
            ...
            // httpPost.setHeader(HTTP.CONTENT_TYPE, "application/x-www-form-urlencoded; charset="
            // + encodeCharset);
            // 构建POST请求的表单参数
            if (null != params)
            {
     ...
     * Map map=new HashMap();
     * String returnBody=
     * " {'user':{'userName':'cjpg','userRealName':'测试','from':'StarC','role':'teacher'}}";
