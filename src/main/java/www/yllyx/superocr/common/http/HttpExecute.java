...
public class HttpExecute extends HttpClientUtils
{
     ...
     */
    public String executeByPOST(List<BasicNameValuePair> params) throws ClientProtocolException,
        IOException
    {
     ...
     * @throws ClientProtocolException
     */
    public String executeByGET() throws ClientProtocolException,
        IOException
    {
        CloseableHttpClient httpclient = getHttpClient();
     ...
     * @throws IOException
     */
    public String executeFileByPost(String filePath, List<BasicNameValuePair> params)
        throws IOException
    {
        CloseableHttpClient httpclient = getHttpClient();
     ...
     * @throws IOException
     */
    public String executeFileByPost(InputStream is, List<BasicNameValuePair> params, Object obj)
        throws IOException
    {
        CloseableHttpClient httpclient = getHttpClient();
     ...
     * @throws IOException
     */
    public String readStreamByGET() throws ClientProtocolException,
        IOException
    {
        CloseableHttpClient httpclient = getHttpClient();
        HttpGet httpget = new HttpGet(url);
